...
import VirtualMCPToolsTab from "./virtualMcpToolsTab";
					...
					<Tabs value={tab} onValueChange={setTab} className="flex grow flex-col overflow-hidden">
						...
						<div className="grow overflow-y-auto px-4 py-5 md:px-8">
							...
							<TabsContent value="tools" className="mt-0">
								<VirtualMCPToolsTab value={tools} onChange={setTools} active={tab === "tools"} />
							</TabsContent>
							...
							<TabsContent value="connect" className="mt-0">
								<VirtualMCPConnectTab slug={existing?.endpoint_slug ?? ""} enabled={enabled} isCreate={isCreate} active={tab === "connect"} />
							</TabsContent>
						</div>
					</Tabs>
				)}
